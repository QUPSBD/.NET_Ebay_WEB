...
{
    public class WristWatches
    {
        private IWebDriver __driver;
        private WebDriverWait wait;

        public WristWatches(IWebDriver __driver)
        {
        ...
        public void VerifyWristWatchesPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.wristWatchesUrl);
            Console.WriteLine("Successfully visit " + Locators.wristWatchesUrl);
        }
    }
}
