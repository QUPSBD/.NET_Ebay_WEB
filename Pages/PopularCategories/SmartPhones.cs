...
namespace EbayDemo.Pages.PopularCategories.PageObjects
{
    public class SmartPhones
    {
        ...
        public SmartPhones(IWebDriver __driver)
        {
        ...
        public void VerifySmartPhonesPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.smartPhonesUrl);
            Console.WriteLine("Successfully visit " + Locators.smartPhonesUrl);
        }
    }
}
