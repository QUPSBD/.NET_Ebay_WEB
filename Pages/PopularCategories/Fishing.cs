...
namespace EbayDemo.Pages.PopularCategories.PageObjects
{
    public class Fishing
    {
        ...
        public Fishing(IWebDriver __driver)
        {
        ...
        public void VerifyFishingPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.fishingUrl);
            Console.WriteLine("Successfully visit " + Locators.fishingUrl);
        }
    }
}
