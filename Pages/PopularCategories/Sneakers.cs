...
namespace EbayDemo.Pages.PopularCategories.PageObjects
{
    public class Sneakers
    {
        ...
        public Sneakers(IWebDriver __driver)
        {
        ...
        public void VerifySneakersPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.sneakersUrl);
            Console.WriteLine("Successfully visit " + Locators.sneakersUrl);
        }
    }
}
