...
namespace EbayDemo.Pages.PopularCategories.PageObjects
{
    public class Collectibles
    {
        ...
        public Collectibles(IWebDriver __driver)
        {
        ...
        public void VerifyCollectiblesPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.collectiblesUrl);
            Console.WriteLine("Successfully visit " + Locators.collectiblesUrl);
        }
    }
}
