...
{
    public class PopularSell
    {
        private IWebDriver __driver;
        private WebDriverWait wait;

        public PopularSell(IWebDriver __driver)
        {
        ...
        public void VerifyPopularSellPage()
        {
            ...
            Assert.AreEqual(__driver.Url, Locators.popularSellUrl);
            Console.WriteLine("Successfully visit " + Locators.popularSellUrl);
        }
    }
}
